...
1. AFS algorithm and AFS structure
2. AFS clustering
...
3. Use the algorithm to first generate the AFS structure and calculate the membership
4. Make the final clustering results avaliable
